# This script is what the team would use for the Radios. It now makes fake data, but it's easily to impelement the sensors measurements in that part of the code. This script implements the two scripts from the Example codes folder.
