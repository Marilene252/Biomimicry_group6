"""
This script shows the full pyPS4Controller library and some controls are connected to the motor drivers.
This script is handy for implementing PS4 controls in other scripts.
"""
