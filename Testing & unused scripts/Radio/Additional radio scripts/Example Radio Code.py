"""
The script shows how the radios work. It has many commands to explain what each line does.
Because of these commands this script is also easily to implenent in other scripts.
"""
